...
**Structural Loss Tracking**: Per-epoch average Sobel L1 loss accumulated across validation batches for both translation directions, reported alongside FID scores.
